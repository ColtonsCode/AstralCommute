...
bool runExample(tgui::GuiBase& gui)
{
    try
    {
        tgui::Theme theme{"../../extlibs/TGUI/themes/Black.txt"};

        gui.add(tgui::Picture::create("../../extlibs/TGUI/examples/RedBackground.jpg"));
        ...
        sf::Texture texture;
        sf::Sprite  sprite;
        texture.loadFromFile("../../extlibs/TGUI/examples/ThinkLinux.jpg");
